...
def main():
    jta = actionlib.SimpleActionClient('/youbot/controller/youbot_trajectory/follow_joint_trajectory', FollowJointTrajectoryAction)
    jta.wait_for_server()
    ...
    point[2].time_from_start = rospy.Duration(12)
    ...
    point[3].time_from_start = rospy.Duration(18)
    ...
    point[4].time_from_start = rospy.Duration(24)
